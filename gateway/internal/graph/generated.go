...
func (ec *executionContext) field_Mutation_createAccount_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["account"]; ok {
		...
		arg0, err = ec.unmarshalNAccountInput2githubᚗcomᚋprathusinghᚋmintᚑservicesᚋgatewayᚋinternalᚋgraphᚋmodelᚐAccountInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createAccount(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOAccount2ᚖgithubᚗcomᚋprathusinghᚋmintᚑservicesᚋgatewayᚋinternalᚋgraphᚋmodelᚐAccount(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_account(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Account)
	fc.Result = res
	return ec.marshalNAccount2ᚖgithubᚗcomᚋprathusinghᚋmintᚑservicesᚋgatewayᚋinternalᚋgraphᚋmodelᚐAccount(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNAccount2githubᚗcomᚋprathusinghᚋmintᚑservicesᚋgatewayᚋinternalᚋgraphᚋmodelᚐAccount(ctx context.Context, sel ast.SelectionSet, v model.Account) graphql.Marshaler {
	return ec._Account(ctx, sel, &v)
}

func (ec *executionContext) marshalNAccount2ᚖgithubᚗcomᚋprathusinghᚋmintᚑservicesᚋgatewayᚋinternalᚋgraphᚋmodelᚐAccount(ctx context.Context, sel ast.SelectionSet, v *model.Account) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNAccountInput2githubᚗcomᚋprathusinghᚋmintᚑservicesᚋgatewayᚋinternalᚋgraphᚋmodelᚐAccountInput(ctx context.Context, v interface{}) (model.AccountInput, error) {
...
func (ec *executionContext) marshalOAccount2ᚖgithubᚗcomᚋprathusinghᚋmintᚑservicesᚋgatewayᚋinternalᚋgraphᚋmodelᚐAccount(ctx context.Context, sel ast.SelectionSet, v *model.Account) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Account(ctx, sel, v)
